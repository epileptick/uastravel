                      ...
                      <!--BEGIN List 1-->
                        <li>
                          <div class="list_packet">
                            ...
                            <div class="row">
                              <div class="twelve columns">
                                <a href=""><img src="images/packet/1.png"></a>
                              </div>
                              <div class="twelve columns">
                                <div class="row">
                                  <div class="nine columns">
...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('themes/Travel/tour/avascripts/powertip/jquery.powertip.css'); ?>" />
<script type="text/javascript">
  $(function() {
    // placement examples
...
<script>
  $(function() {
    ...
    $('.connected:has(li)').addClass("test");
  });
