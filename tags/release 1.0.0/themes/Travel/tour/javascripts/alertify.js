	...
	Alertify = function () {
		...
		dialogs = {
			buttons : {
				...
				submit : "<button type=\"submit\" class=\"alertify-button alertify-button-ok button green\" id=\"alertify-ok\">{{ok}}</button>",
				ok     : "<a href=\"#\" class=\"alertify-button alertify-button-ok button green\" id=\"alertify-ok\">{{ok}}</a>",
				cancel : "<a href=\"#\" class=\"alertify-button alertify-button-cancel button red\" id=\"alertify-cancel\">{{cancel}}</a>"
			},
