...
<head>
  ...
  <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
    ...
    <!-- Le styles -->
<?php
PageUtil::addVar("stylesheet",'<link rel="stylesheet" href="'.base_url("themes/Travel/tour/bootstrap/css/bootstrap.css").'">');
PageUtil::addVar("stylesheet",'<link rel="stylesheet" href="'.base_url("themes/Travel/tour/bootstrap/css/bootstrap-responsive.css").'">');
PageUtil::addVar("stylesheet",'<link rel="stylesheet" href="'.base_url("themes/Travel/tour/stylesheets/main.css").'">');
...
?>
  ...
  <body>
      ...
      <div class="row-fluid">
        <div class="span12">
          <div class="sidebar" style="display:none;">
            <header class="header">
              <a class="logo"> <img src="images/logo_home.png"></a>
              <div class="address">
                ...
                <div class="span12">
                  <div id="attractions" style="display:none;" class="clickable variable-sizes">
                      ...
                      <div class="list_attractions transition metal" data-category="transition">
                        ...
                        <a href="detail.html">
                          <img src="images/attractions/p5.png">
                          <div><span></span></div>
                        </a>
                        <div class="row-fluid">
                          <div class="span8">
                      ...
                      <div class="list_attractions metalloid" data-category="metalloid">
                        <a href="detail.html">
                          <img src="images/attractions/p11.png">
                          <div><span></span></div>
                        </a>
                        <div class="row-fluid">
                          <div class="span8">
                      ...
                      <div class="list_attractions post-transition metal" data-category="post-transition">
                        <a href="detail.html">
                          <img src="images/attractions/p3.png">
                          <div><span></span></div>
                        </a>
                            <div class="row-fluid">
                          <div class="span8">
                      ...
                      <div class="list_attractions transition metal" data-category="transition">
                        ...
                        <a href="detail.html">
                          <img src="images/attractions/p1.png">
                          <div><span></span></div>
                        </a>
                        <div class="row-fluid">
                          <div class="span8">
                      ...
                      <div class="list_attractions alkaline-earth metal" data-category="alkaline-earth">
                        <a href="detail.html">
                          <img src="images/attractions/p2.png">
                          <div><span></span></div>
                        </a>
                        <div class="row-fluid">
                          <div class="span8">
                      ...
                      <div class="list_attractions transition metal" data-category="transition">
                        ...
                        <a href="detail.html">
                          <img src="images/attractions/p6.png">
                          <div><span></span></div>
                        </a>
                        <div class="row-fluid">
                          <div class="span8">
                      ...
                      <div class="list_attractions post-transition metal" data-category="post-transition">
                        <a href="detail.html">
                          <img src="images/attractions/p9.png">
                          <div><span></span></div>
                        </a>
                        <div class="row-fluid">
                          <div class="span8">
                      ...
                      <div class="list_attractions metalloid" data-category="metalloid">
                        <a href="detail.html">
                          <img src="images/attractions/p4.png">
                          <div><span></span></div>
                        </a>
                        <div class="row-fluid">
                          <div class="span8">
                      ...
                      <div class="list_attractions transition metal" data-category="transition">
                        <a href="detail.html">
                          <img src="images/attractions/p10.png">
                          <div><span></span></div>
                        </a>
                        <div class="row-fluid">
                          <div class="span8">
                      ...
                      <div class="list_attractions lanthanoid metal inner-transition" data-category="lanthanoid">
                        ...
                        <a href="detail.html">
                          <img src="images/attractions/p7.png">
                          <div><span></span></div>
                        </a>
                        <div class="row-fluid">
                          <div class="span8">
                      ...
                      <div class="list_attractions noble-gas nonmetal" data-category="noble-gas">
                        <a href="detail.html">
                          <img src="images/attractions/p14.png">
                          <div><span></span></div>
                        </a>
                        <div class="row-fluid">
                          <div class="span8">
                      ...
                      <div class="list_attractions alkali metal" data-category="alkali">
                        <div class="sticker new">New</div>
                        <a href="detail.html">
                          <img src="images/attractions/p12.png">
                          <div><span></span></div>
                        </a>
                        <div class="row-fluid">
                          <div class="span8">
                      ...
                      <div class="list_attractions other nonmetal" data-category="other">
                        <a href="detail.html">
                          <img src="images/attractions/p13.png">
                          <div><span></span></div>
                        </a>
                        <div class="row-fluid">
                          <div class="span8">
                      ...
                      <div class="list_attractions actinoid metal inner-transition" data-category="actinoid">
                        <a href="detail.html">
                          <img src="images/attractions/p8.png">
                          <div><span></span></div>
                        </a>
                        <div class="row-fluid">
                          <div class="span8">
                      ...
                      <div class="list_attractions actinoid metal inner-transition" data-category="actinoid">
                        <a href="detail.html">
                          <img src="images/attractions/p15.png">
                          <div><span></span></div>
                        </a>
                        <div class="row-fluid">
                          <div class="span8">
                      ...
                      <div class="list_attractions actinoid metal inner-transition" data-category="actinoid">
                        <a href="detail.html">
                          <img src="images/attractions/p16.png">
                          <div><span></span></div>
                        </a>
                        <div class="row-fluid">
                          <div class="span8">
    ...
    <!-- Hover Effect -->
    <script type="text/javascript" src="javascripts/DirectionAwareHoverEffect/js/jquery.hoverdir.js"></script>
    <noscript>
      <style>
    ...
    <!-- Isotope -->
    <script src="javascripts/isotope/jquery.isotope.min.js"></script>
    <script src="javascripts/isotope/js/jquery.infinitescroll.min.js"></script>


    <!-- Jquery Search -->
    <script src="javascripts/jquerysearch/js/jquery.color.js"></script>
    <script src="javascripts/jquerysearch/js/script.js"></script>

    <!-- Full Screen -->
    <script type="text/javascript" src="javascripts/Full-screen/jquery.fullscreen-min.js"></script>
