...
<section class="similar_hotels grid_12">
		...
		<h2 class="section_heading">Airline Booking List</h2>
		<ul>
			...
			?>							
				<li>
					...
					<h3><a href="#"><?php echo $value->code;?></a></h3>
						...
						[ <a href='<?php echo base_url("admin/report/airline/custom/$value->hashcode");?>'>Custom</a> ]
						[ <a href='<?php echo base_url("admin/report/airline/operator/$value->hashcode");?>'>Airline Operator</a> ]
