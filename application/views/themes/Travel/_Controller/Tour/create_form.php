...
<div class="container_12">
	...
	<section class="grid_8">
		...
		<?php echo form_open(base_url("index.php/tour/create"));?>.
			...
			<div class="half">
				...
				<input type="text" name="net_adult_price" value="<?php echo set_value('net_adult_price');?>">
			</div>	

			<div class="half last">
				<label>Net Price Children(th) :</label><br>
				<?php echo form_error('net_child_price', '<font color="red">', '</font>'); ?>
				<input type="text" name="net_child_price" value="<?php echo set_value('net_child_price');?>">
			</div>			
			<div class="clearfix"></div>
			...
			<div class="half">
				...
				<input type="text" name="sale_adult_price" value="<?php echo set_value('sale_adult_price');?>">
			</div>			

			<div class="half last">
				<label>Sale Price Child(th) :</label><br>
				<?php echo form_error('sale_child_price', '<font color="red">', '</font>'); ?>
				<input type="text" name="sale_child_price" value="<?php echo set_value('sale_child_price');?>">
			</div>			
			<div class="clearfix"></div>
