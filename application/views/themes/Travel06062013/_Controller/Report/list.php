...
<section class="similar_hotels grid_12">
		...
		<h2 class="section_heading">Agent List [ <a href='<?php echo base_url("report/create");?>'>Create</a> ]</h2>
		<ul>
			...
			?>							
				<li>
					...
					<h3><a href="#"><?php echo $value->name;?></a></h3>
						...
						[ <a href='<?php echo base_url("report/create/$value->id");?>'>Edit</a> ]
						[ <a href='<?php echo base_url("report/delete/$value->id");?>'>Delete</a> ]
					</span><br>
					<div>
