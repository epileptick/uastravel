...
<head>
  <title><?php echo $booking[2]->tob_code."(".$booking[2]->tob_tour_name.")";?></title>
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
  <meta name="ROBOTS" content="NOODP" />
  <meta name="description" content="จอง<?php echo $booking[2]->tob_tour_name.'('.$booking[2]->tob_tour_code.')';?>" />
          ...
          <div class="six columns">
            ...
            <div class="row">
              <div class="twelve columns" >
                ...
                <div class="seven columns">
                <h5>
                 <?php echo $booking[2]->tob_tour_name;?>
                </h5> 
                </div>
              </div>
            </div>  
            ...
            <div class="row">
              <div class="twelve columns">
                ...
                <div class="seven columns">
                <h5>
                 <?php echo $booking[2]->tob_firstname;?> <?php echo $booking[2]->tob_lastname;?>
                </h5> 
                </div>
              </div>
            </div>    
            ...
            <div class="row">
              <div class="twelve columns">
                ...
                <div class="seven columns">
                <h5>
                 <?php echo $booking[2]->tob_nationality;?>
                </h5> 
                </div>
              </div>
            </div> 
            ...
            <div class="row">
              <div class="twelve columns">
                ...
                <div class="seven columns">
                <h5>
                 <?php echo $booking[2]->tob_address;?>, <?php echo $booking[2]->tob_city;?>, <?php echo $booking[2]->tob_province;?>, <?php echo $booking[2]->tob_zipcode;?>
                </h5> 
                </div>
              </div>
            </div>          
            ...
            <div class="row">
              <div class="twelve columns">
                ...
                <div class="seven columns">
                <h5>
                 <?php echo $booking[2]->tob_telephone;?>
                </h5> 
                </div>
              </div>
            </div> 
            ...
            <div class="row">
              <div class="twelve columns">
                ...
                <div class="seven columns">
                  ...
                  <h5>
                   <?php 
                      $dateExplode = explode("-", $booking[2]->tob_tranfer_date);
            ...
            <div class="row">
              <div class="twelve columns">
                ...
                <div class="seven columns">
                  ...
                  <h5>
                   <?php 
                    if(!empty($booking[2]->tob_hotel_name)){
                      echo $booking[2]->tob_hotel_name;
                    }else{
                      echo "-";
                    }
                   ?>
            ...
            <div class="row">
              <div class="twelve columns">
                ...
                <h5>
                 <?php 
                  if($booking[2]->tob_room_number != 0){
                    echo $booking[2]->tob_room_number;
                  }else{
                    echo "-";
                  }
                 ?>
            ...
            <div class="row">
              <div class="twelve columns">
                ...
                <div class="seven columns">
                <h5>
                 <?php echo $booking[2]->tob_request;?>
                </h5> 
                </div>
              </div> 
            </div> 
          ...
          <div class="six columns">
            ...
            <div class="row">
              <div class="twelve columns">
                ...
                <div class="seven columns">
                <h5>
                 <?php echo $booking[2]->tob_adult_amount;?>
                </h5> 
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="twelve columns">
                ...
                <div class="seven columns">
                <h5>
                 <?php echo $booking[2]->tob_child_amount;?>
                </h5> 
                </div>
              </div>
            </div>    
            ...
            <div class="row">
              <div class="twelve columns">
                ...
                <div class="seven columns">
                <h5>
                 <?php echo $booking[2]->tob_infant_amount;?>
                </h5> 
                </div>
              </div>
            </div>   
        ...
        <div class="border"></div>
            ...
            <div class="row">
              <div class="twelve columns">
                ...
                <div class="seven columns">
                <h5>
                 <?php echo number_format($booking[2]->tob_total_adult_price, 0);?> บาท
                </h5> 
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="twelve columns">
                ...
                <div class="seven columns">
                <h5>
                 <?php echo number_format($booking[2]->tob_total_child_price, 0);?> บาท
                </h5> 
                </div>
              </div>
            </div>    
        <?php
          if(!empty($booking[2]->tob_extend_price)){
        ?>
        <div class="clearfix"></div>
        <div class="border"></div>
            <div class="row">
              ...
              <div class="twelve columns">
                ...
                <div class="eight columns">
                  <h5>
                      ...
                      <?php
                       $extend_price =  unserialize($booking[2]->tob_extend_price); 
            ...
            <div class="row">
              <div class="twelve columns">
                ...
                <div class="eight columns">
                <h5>
                 <?php echo number_format($booking[2]->tob_total_adult_extend_price, 0);?> บาท
                </h5> 
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="twelve columns">
                ...
                <div class="eight columns">
                <h5>
                 <?php echo number_format($booking[2]->tob_total_child_extend_price, 0);?> บาท
                </h5> 
                </div>
              </div>
            </div>    
              ...
              <div class="twelve columns"   style="border-style:solid; border-width:1px;">
                ...
                <div class="seven columns">
                  <h5 style="color:red; font-size:200%; margin-top:10px !important;" >
                    <?php echo number_format($booking[2]->tob_total_price, 0);?> บาท
                  </h5> 
                </div>
              </div>
            </div>
