...
<!-- END col-md-4 and row  -->
  ...
  <div class="col-md-8 bordershadow">
     <h2 class="head_title pull-left col-md-12" ><span style="font-size:23px;"></span><?php echo $location["title"];?></h2>
    <div class="row">
  ...
  <div class="row">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <?php
                  if(! empty($location['body_column'][0])){
                    echo $location['body_column'][0];
                    echo $location['body_column'][1];
                    echo $location['body_column'][2];
                  }
                  ?>
        </div>
