...
<!-- End Header -->
      ...
      <div class="row">
        <div class="twelve columns">
            <h3>
              <font style="color:#FE5214;">หมายเลขการจอง : </font> <b><?php echo $booking[0]->cab_code;?> </b>( จองรถเช่า ) <br/><br/>
              <div class="border"></div> 
              คุณได้ทำการจองรถเช่าผ่านทาง Uastravel.com</br><br/>
              ดูรายละเอียดการจองรถเช่าทั้งหมดได้ที่อีเมล์ของท่าน<br/><br/>
