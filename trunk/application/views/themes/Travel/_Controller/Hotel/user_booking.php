...
<head>
  ...
  <meta name="description" content="จอง<?php echo $booking[0]->hob_firstname.'('.$booking[0]->hob_code.')';?>" />
          ...
          <div class="six columns">
            ...
            <div class="row">
              <div class="twelve columns">
                ...
                <div class="seven columns">
                <h5>
                 <?php echo $booking[0]->hob_firstname;?> <?php echo $booking[0]->hob_lastname;?>
                </h5> 
                </div>
              </div>
            </div>    
            ...
            <div class="row">
              <div class="twelve columns">
                ...
                <div class="seven columns">
                <h5>
                 <?php echo $booking[0]->hob_nationality;?>
                </h5> 
                </div>
              </div>
            </div> 
            ...
            <div class="row">
              <div class="twelve columns">
                ...
                <div class="seven columns">
                <h5>
                 <?php echo $booking[0]->hob_address;?>, <?php echo $booking[0]->hob_city;?>, <?php echo $booking[0]->hob_province;?>, <?php echo $booking[0]->hob_zipcode;?>
                </h5> 
                </div>
              </div>
            </div>          
            ...
            <div class="row">
              <div class="twelve columns">
                ...
                <div class="seven columns">
                <h5>
                 <?php echo $booking[0]->hob_telephone;?>
                </h5> 
                </div>
              </div>
            </div> 
    ...
    <!-- Amount -->
          ...
          <div class="row">
              <div class="twelve columns">
                ...
                <div class="seven columns">
                <h5>
                 <?php echo $booking[0]->hob_adult_amount;?>
                </h5> 
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="twelve columns">
                ...
                <div class="seven columns">
                <h5>
                 <?php echo $booking[0]->hob_child_amount;?>
                </h5> 
                </div>
              </div>
            </div>    
            ...
            <div class="row">
              <div class="twelve columns">
                ...
                <div class="seven columns">
                <h5>
                 <?php echo $booking[0]->hob_infant_amount;?>
                </h5> 
                </div>
              </div>
            </div>  
    ...
    <!-- Airline Booking-->
          <div class="six columns">
            <div class="row">
              <div class="twelve columns">
                <h5>
                    <b>รายละเอียดการจองโรงแรม (Hotel Booking Information) </b>
                </h5> 
              </div>
            </div>
            ...
            <div class="row">
              <div class="twelve columns">
                ...
                <div class="seven columns">
                <h5>
                 <?php echo $booking[0]->hob_hotelname;?>
                </h5> 
                </div>
              </div>
            </div> 
            ...
            <div class="row">
              <div class="twelve columns">
                ...
                <div class="seven columns">
                <h5>
                 <?php echo $booking[0]->hob_room_amount;?> ห้อง
                </h5> 
                </div>
              </div>
            </div> 
            ...
            <div class="row">
              <div class="twelve columns">
                ...
                <div class="seven columns">
                  ...
                  <h5>
                   <?php 
                      $dateExplode = explode("-", $booking[0]->hob_checkin_date);
                      $hob_checkin_date = $dateExplode[2]."/".$dateExplode[1]."/".$dateExplode[0];
                      echo $hob_checkin_date;
                   ?>
                  </h5> 
                </div>
              </div>
            ...
            <div class="row">
              <div class="twelve columns">
                ...
                <div class="seven columns">
                  ...
                  <h5>
                   <?php 
                      $dateExplode = explode("-", $booking[0]->hob_checkout_date);
                      $hob_checkout_date = $dateExplode[2]."/".$dateExplode[1]."/".$dateExplode[0];
                      echo $hob_checkout_date;
                   ?>
                  </h5> 
                </div>
              </div>
            ...
            <div class="row">
              <div class="twelve columns">
                ...
                <div class="seven columns">
                <h5>
                 <?php echo $booking[0]->hob_message;?>
                </h5> 
                </div>
              </div> 
            </div> 
