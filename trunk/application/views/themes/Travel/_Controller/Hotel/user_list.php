            ...
            <div class="content">
              <div class="row-fluid">
                <div class="navbar">
                    <div class="navbar-inner">
                        ...
                        <div id="options" class="nav-collapse collapse">
                          <ul class="option-set nav" >
                            <li>
                                <a href="<?php echo base_url('hotel/list/ทั้งหมด');?>" class="selected">ทั้งหมด</a>
                    ...
                    ?> 
                              <li>  
                                <a href="<?php echo $value["meu_url"];?>"> <?php echo $value["meu_province"]; ?></a> 
                             </li>     
                   <?php
                     }
                   ?>                           
                ...
                <div class="navbar">                                       
                   ...
                   <?php 
                    ...
                    ?> 
                              <li>  
                                <a href="<?php echo $value["sme_url"];?>"> <?php echo $value["sme_location"]; ?></a> 
                             </li>     
                   <?php
                     }
                   ?> 
                  ...
                  <div id="attractions" style="display:none;" class="clickable variable-sizes">
                    ...
                    ?>
                            ...
                            <div class="list_attractions" data-category="transition">
                              ...
                              <a href="<?php echo $value["hot_url"];?>" target="_blank">
                                  <img src="<?php echo $value["hot_firstimage"];?>" />
                                      <div><span></span></div>
                              </a>
                              <div class="row-fluid">
                                <div class="span8">
