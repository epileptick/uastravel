...
$(document).ready(function() {
  ...
  $("#btnDelete").click(
    function () {
      $.post("'.base_url('location/ajax_delete').'", $("#locationList").serialize(),
        function(data) {
          location.reload();
      });
    }
...
<section class="similar_hotels grid_12">
    ...
    <div class="topHolder bottom-shadow">
      ...
      <span class="GM1BAGKBGJB">
      <button class="blogg-button blogg-collapse-right" tabindex="0" href='<?php echo base_url("location/create");?>'><?php echo $this->lang->line("location_lang_publish");?></button>
      <button class="blogg-button blogg-collapse-left blogg-collapse-right" tabindex="0" href='<?php echo base_url("location/create");?>'><?php echo $this->lang->line("location_lang_unpublish");?></button>
      ...
      <span class="GM1BAGKBNIB">
        <a class="blogg-button blogg-primary" tabindex="0" href='<?php echo base_url("location/create");?>'><?php echo $this->lang->line("location_lang_add_post");?></a>
      </span>
      ...
      ?>
        <li>
          ...
          <div>
            ...
            <span id="location-list-control"><a href="<?php echo base_url("location/delete/$value[id]");?>"><?php echo $this->lang->line("global_lang_delete");?></a> | <a href="<?php echo base_url("location/create/$value[id]");?>"><?php echo $this->lang->line("global_lang_edit");?></a></span>
          </div>
