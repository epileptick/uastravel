...
<section class="similar_hotels grid_12">
		...
		<h2 class="section_heading">Carrent Booking List</h2>
		<ul>
			...
			?>							
				<li>
					...
					<h3><a href="#"><?php echo $value->code;?></a></h3>
						...
						[ <a href='<?php echo base_url("admin/report/carrent/custom/$value->hashcode");?>'>Custom</a> ]
						[ <a href='<?php echo base_url("admin/report/carrent/operator/$value->hashcode");?>'>Car Operator</a> ]
